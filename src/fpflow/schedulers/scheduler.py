...
class Scheduler:
    ...
    def from_scheds_dict(cls, system_name: str, scheds_dict: dict):
        ...
        is_interactive: bool = False if jmespath.search('is_interactive', system_dict)==None else jmespath.search('is_interactive', system_dict)
    ...
    def from_sched_yamlfilename(cls, system_name: str, filename: str = None, update_dict: dict={}):
        ...
        system_dict: dict = jmespath.search(f'{system_name}', scheds_dict)
        if system_dict==None: system_dict = {}
    ...
    def from_input_yamlfilename(cls, filename: str='./input.yaml'):
        ...
        update_dict: dict = {} if jmespath.search('scheduler.args', inputdict)==None else jmespath.search('scheduler.args', inputdict)
    ...
    def get_script_header(self, info: JobInfo):
        ...
        header += f'{"" if self.extra_commands==None else self.extra_commands}\n'
    ...
    def get_exec_prefix(self, info: JobInfo):
        ...
        if self.mpi_exec!=None and self.mpi_exec!='':
    ...
    def get_launch_exec(self, info: JobInfo):
        ...
        if self.batchscript_exec!=None and self.batchscript_exec!='':
